  ...
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_icurrentColoronCarrier">
      ...
      <path
        ...
        stroke-linejoin="round"
      ></path>
      <path d="M6 9H12" stroke="currentColor" stroke-width="1.5" stroke-linecurrentcap="round" stroke-linejoin="round"></path>
      <path d="M6.75 13H11.25" stroke="currentColor" stroke-width="1.5" stroke-linecurrentcap="round" stroke-linejoin="round"></path>
    </g>
  </svg>
</template>
